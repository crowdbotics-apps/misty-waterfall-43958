"""
Django settings for misty_waterfall_43958 project.
...
ROOT_URLCONF = 'misty_waterfall_43958.urls'
...
WSGI_APPLICATION = 'misty_waterfall_43958.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_waterfall_43958 API",
    "DESCRIPTION": "API documentation for misty_waterfall_43958 App",
    "VERSION": "v1",
}
